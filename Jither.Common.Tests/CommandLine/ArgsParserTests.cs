...
namespace Jither.CommandLine
{
    ...
    {
        private static readonly OptionDefinition OptionTest = new OptionDefinition("test", 't', typeof(string));
        private static readonly OptionDefinition OptionFoo = new OptionDefinition("foo", 'f', typeof(string));
        private static readonly OptionDefinition OptionBar = new OptionDefinition("bar", 'b', typeof(string));
        private static readonly OptionDefinition OptionSwitch = new OptionDefinition("switch", 's', typeof(bool));
        private static readonly OptionDefinition OptionList = new OptionDefinition("list", 'l', typeof(List<string>));
        private static readonly PositionalDefinition Positional0 = new PositionalDefinition(0, typeof(string));
        private static readonly PositionalDefinition Positional1 = new PositionalDefinition(1, typeof(string));

        private readonly ArgumentDefinitions emptyDefinitions = new ArgumentDefinitions(Enumerable.Empty<PositionalDefinition>(), Enumerable.Empty<OptionDefinition>());
