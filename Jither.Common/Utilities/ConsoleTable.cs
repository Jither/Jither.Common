...
{
    private readonly List<ConsoleTableColumn> columns = new();
    private readonly List<ConsoleTableRow> rows = new();
    ...
    public string ToString(int width)
    {
        ...
        var columnSpace = new String(' ', columnSpacing);

        var wrappingRemainders = new List<WrappingRemainder>();
